          ...
          <div className="mt-6 min-w-[600px] flex flex-col items-center">
            ...
            <div className="w-[80%] mb-4">
              ...
              <select
                ...
                className="mt-2 py-2 pr-7 cursor-pointer block outline-none w-full rounded-md border-0 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
              >
